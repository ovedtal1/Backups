...
class BilinearPoolingFusionNet(nn.Module):
    def __init__(self):
        ...
        self.param2 = nn.Parameter(torch.normal(0, 0.00, size=(198,)))  
        self.epsilon = 1e-6
...
class ViTfuser(nn.Module):
    def __init__(self, net, epsilon=1e-6):
        ...
        # Low Resolution
        self.param1 = nn.Parameter(torch.normal(0.7, 0.0, size=(256,)))
        self.param2 = nn.Parameter(torch.normal(0.3, 0.02, size=(256,)))
