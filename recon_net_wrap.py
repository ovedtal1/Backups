...
class BilinearPoolingFusionNet(nn.Module):
    def __init__(self):
        ...
        self.param1 = nn.Parameter(torch.normal(0.9, 0.0, size=(198,)))
        self.param2 = nn.Parameter(torch.normal(0.1, 0.005, size=(198,)))  
        self.epsilon = 1e-6
...
class ViTfuser(nn.Module):
    def __init__(self, net, epsilon=1e-6):
        ...
        # Low Resolution
        self.param1 = nn.Parameter(torch.normal(0.9, 0.00, size=(198,)))
        self.param2 = nn.Parameter(torch.normal(0.1, 0.05, size=(198,)))
